      ...
      <div className="relative z-10 max-w-md w-full text-center animate-fade-in">
        <div className="glass rounded-2xl p-8">
          ...
          <div className="bg-white/5 rounded-xl p-4 mb-6 text-left space-y-2">
            <p className="text-xs text-white/60 uppercase tracking-wider font-medium">Yang perlu dilakukan:</p>
          ...
          <button
            onClick={signOut}
            className="mt-6 text-sm text-white/50 hover:text-white/60 transition-colors"
          >
            Keluar
          </button>
        </div>
